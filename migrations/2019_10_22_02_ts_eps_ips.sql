...
SELECT t2.ID,t2.NumeroFactura,t2.Estado,t2.DepartamentoRadicacion,t1.NoRelacionada,
        ...
        (SELECT IF(TipoNegociacion='CAPITA',
                                 (SELECT COUNT(NumeroFactura) FROM carteraeps ce WHERE ce.MesServicio= t2.MesServicio AND ce.CarteraEPSTipoNegociacion='CAPITA' AND ce.CodigoSucursal=t2.CodigoSucursal) ,
