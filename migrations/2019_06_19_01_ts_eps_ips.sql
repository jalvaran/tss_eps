...
CREATE TABLE `vista_cruce_cartera_asmet` (`ID` bigint(20), `NumeroFactura` varchar(20), `Estado` int(11), `DepartamentoRadicacion` varchar(25), `NoRelacionada` int(1), `FechaFactura` date, `MesServicio` int(6), `NumeroRadicado` varchar(90), `Pendientes` varchar(2), `FechaConciliacion` datetime, `FechaRadicado` date, `NumeroContrato` varchar(40), `ValorDocumento` double(15,2), `Impuestos` double(19,2), `ImpuestosSegunASMET` double(19,2), `ValorMenosImpuestos` double(15,2), `TotalPagosNotas` double(19,2), `Capitalizacion` double(19,2), `TotalPagos` double(19,2), `TotalAnticipos` double(19,2), `DescuentoPGP` double(19,2), `FacturasDevueltas` double(19,2), `NumeroFacturasDevueltasAnticipos` bigint(21), `TotalCopagosNotas` double(19,2), `TotalCopagos` double(19,2), `OtrosDescuentos` double(19,2), `AjustesCartera` double(19,2), `TotalGlosaInicial` double(15,2), `TotalGlosaFavor` double(15,2), `TotalGlosaContra` double(15,2), `GlosaXConciliar` double(19,2), `DevolucionesPresentadas` bigint(21), `FacturasPresentadas` bigint(21), `FacturaActiva` varchar(2), `TotalDevolucionesNotas` double(15,2), `TotalDevoluciones` double(19,2), `CarteraXEdades` double(19,2), `ValorSegunEPS` double(19,2), `ValorSegunIPS` double(17,0), `Diferencia` double(19,2), `ValorIPSMenor` varchar(2), `TotalConciliaciones` double(19,2), `ConciliacionesAFavorEPS` double(19,2), `ConciliacionesAFavorIPS` double(19,2), `TotalAPagar` double(19,2), `ConciliacionesPendientes` varchar(2));


CREATE TABLE `vista_cruce_cartera_eps` (`ID` bigint(20), `NumeroFactura` varchar(20), `Estado` int(11), `DepartamentoRadicacion` varchar(25), `NoRelacionada` bigint(11), `FechaFactura` date, `MesServicio` int(6), `NumeroRadicado` varchar(90), `Pendientes` varchar(2), `FechaConciliacion` datetime, `FechaRadicado` date, `NumeroContrato` varchar(40), `ValorDocumento` double(15,2), `Impuestos` double(19,2), `ImpuestosSegunASMET` double(19,2), `ValorMenosImpuestos` double(15,2), `TotalPagosNotas` double(19,2), `Capitalizacion` double(19,2), `TotalPagos` double(19,2), `TotalAnticipos` double(19,2), `DescuentoPGP` double(19,2), `FacturasDevueltas` double(19,2), `NumeroFacturasDevueltasAnticipos` bigint(21), `TotalCopagosNotas` double(19,2), `TotalCopagos` double(19,2), `OtrosDescuentos` double(19,2), `AjustesCartera` double(19,2), `TotalGlosaInicial` double(15,2), `TotalGlosaFavor` double(15,2), `TotalGlosaContra` double(15,2), `GlosaXConciliar` double(19,2), `DevolucionesPresentadas` bigint(21), `FacturasPresentadas` bigint(21), `FacturaActiva` varchar(2), `TotalDevolucionesNotas` double(15,2), `TotalDevoluciones` double(19,2), `CarteraXEdades` double(19,2), `ValorSegunEPS` double(19,2), `ValorSegunIPS` double(17,0), `Diferencia` double(19,2), `ValorIPSMenor` varchar(2), `TotalConciliaciones` double(19,2), `ConciliacionesAFavorEPS` double(19,2), `ConciliacionesAFavorIPS` double(19,2), `TotalAPagar` double(19,2), `ConciliacionesPendientes` varchar(2), `DiferenciaXPagos` int(1));
...
CREATE TABLE `vista_cruce_totales_actas_conciliaciones` (`NumeroFactura` varchar(20), `Diferencia` double(19,2), `DiferenciaXPagos` double(19,2), `DiferenciaXAnticipos` double(19,2), `DiferenciaXCopagos` double(19,2), `DiferenciaXDescuentoPGP` double(19,2), `DiferenciaXOtrosDescuentos` double(19,2), `DiferenciaXAjustesCartera` double(19,2), `DiferenciaXGlosaFavorEPS` double(19,2), `DiferenciaXGlosaContraEPS` double(19,2), `DiferenciaXGlosaXConciliar` double(19,2), `DiferenciaXDevoluciones` double(19,2), `DiferenciaXImpuestos` double(19,2), `DiferenciaXValorFacturado` double(19,2), `TotalDiferenciasComunes` double(19,2), `DiferenciaXDevolucionesNoIPS` double(19,2), `GlosasXConciliar2` double(19,2), `XPagos2` double(19,2), `DiferenciaVariada` double(19,2));
...
CREATE TABLE `vista_reporte_ips` (`Fecha Factura` date, `Mes servicio` int(6), `Numero Radicado` varchar(90), `Fecha Radicado` date, `Numero Contrato` varchar(40), `Numero factura` varchar(20), `Valor de Factura` double(15,2), `Impuestos Factura` double(19,2), `Pagos` double(19,2), `Anticipos` double(19,2), `Copagos` double(19,2), `Descuentos PGP` double(19,2), `Otros Descuentos` double(19,2), `Ajustes Cartera` double(19,2), `Glosa Aceptada Ips` double(15,2), `Glosa levantada EPS` double(15,2), `Glosa X Conciliar` double(19,2), `Devoluciones` double(19,2), `Saldo Eps` double(19,2), `Saldo Ips` double(17,0), `Valor Diferencia` double(19,2));
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `vista_cruce_cartera_eps_relacionadas_ips` AS select `t1`.`ID` AS `ID`,`t1`.`NumeroFactura` AS `NumeroFactura`,`t1`.`Estado` AS `Estado`,`t1`.`DepartamentoRadicacion` AS `DepartamentoRadicacion`,`t1`.`NoRelacionada` AS `NoRelacionada`,`t1`.`FechaFactura` AS `FechaFactura`,`t1`.`MesServicio` AS `MesServicio`,`t1`.`NumeroRadicado` AS `NumeroRadicado`,`t1`.`Pendientes` AS `Pendientes`,`t1`.`FechaConciliacion` AS `FechaConciliacion`,`t1`.`FechaRadicado` AS `FechaRadicado`,`t1`.`NumeroContrato` AS `NumeroContrato`,`t1`.`ValorDocumento` AS `ValorDocumento`,`t1`.`Impuestos` AS `Impuestos`,`t1`.`ImpuestosSegunASMET` AS `ImpuestosSegunASMET`,`t1`.`ValorMenosImpuestos` AS `ValorMenosImpuestos`,`t1`.`TotalPagosNotas` AS `TotalPagosNotas`,`t1`.`Capitalizacion` AS `Capitalizacion`,`t1`.`TotalPagos` AS `TotalPagos`,`t1`.`TotalAnticipos` AS `TotalAnticipos`,`t1`.`DescuentoPGP` AS `DescuentoPGP`,`t1`.`FacturasDevueltas` AS `FacturasDevueltas`,`t1`.`NumeroFacturasDevueltasAnticipos` AS `NumeroFacturasDevueltasAnticipos`,`t1`.`TotalCopagosNotas` AS `TotalCopagosNotas`,`t1`.`TotalCopagos` AS `TotalCopagos`,`t1`.`OtrosDescuentos` AS `OtrosDescuentos`,`t1`.`AjustesCartera` AS `AjustesCartera`,`t1`.`TotalGlosaInicial` AS `TotalGlosaInicial`,`t1`.`TotalGlosaFavor` AS `TotalGlosaFavor`,`t1`.`TotalGlosaContra` AS `TotalGlosaContra`,`t1`.`GlosaXConciliar` AS `GlosaXConciliar`,`t1`.`DevolucionesPresentadas` AS `DevolucionesPresentadas`,`t1`.`FacturasPresentadas` AS `FacturasPresentadas`,`t1`.`FacturaActiva` AS `FacturaActiva`,`t1`.`TotalDevolucionesNotas` AS `TotalDevolucionesNotas`,`t1`.`TotalDevoluciones` AS `TotalDevoluciones`,`t1`.`CarteraXEdades` AS `CarteraXEdades`,`t1`.`ValorSegunEPS` AS `ValorSegunEPS`,`t1`.`ValorSegunIPS` AS `ValorSegunIPS`,`t1`.`Diferencia` AS `Diferencia`,`t1`.`ValorIPSMenor` AS `ValorIPSMenor`,`t1`.`TotalConciliaciones` AS `TotalConciliaciones`,`t1`.`ConciliacionesAFavorEPS` AS `ConciliacionesAFavorEPS`,`t1`.`ConciliacionesAFavorIPS` AS `ConciliacionesAFavorIPS`,`t1`.`TotalAPagar` AS `TotalAPagar`,`t1`.`ConciliacionesPendientes` AS `ConciliacionesPendientes`,`t1`.`DiferenciaXPagos` AS `DiferenciaXPagos` from `vista_cruce_cartera_eps` `t1` where exists(select 1 from `carteracargadaips` `t2` where (`t1`.`NumeroFactura` = `t2`.`NumeroFactura`));

DROP TABLE IF EXISTS `vista_cruce_totales_actas_conciliaciones`;
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `vista_cruce_totales_actas_conciliaciones` AS select `t1`.`NumeroFactura` AS `NumeroFactura`,`t1`.`Diferencia` AS `Diferencia`,(select if((abs(`t1`.`TotalPagos`) = abs(`t1`.`Diferencia`)),`t1`.`Diferencia`,0)) AS `DiferenciaXPagos`,(select if((abs(`t1`.`TotalAnticipos`) = abs(`t1`.`Diferencia`)),`t1`.`Diferencia`,0)) AS `DiferenciaXAnticipos`,(select if((abs(`t1`.`TotalCopagos`) = abs(`t1`.`Diferencia`)),`t1`.`Diferencia`,0)) AS `DiferenciaXCopagos`,(select if((abs(`t1`.`DescuentoPGP`) = abs(`t1`.`Diferencia`)),`t1`.`Diferencia`,0)) AS `DiferenciaXDescuentoPGP`,(select if((abs(`t1`.`OtrosDescuentos`) = abs(`t1`.`Diferencia`)),`t1`.`Diferencia`,0)) AS `DiferenciaXOtrosDescuentos`,(select if((abs(`t1`.`AjustesCartera`) = abs(`t1`.`Diferencia`)),`t1`.`Diferencia`,0)) AS `DiferenciaXAjustesCartera`,(select if((abs(`t1`.`TotalGlosaFavor`) = abs(`t1`.`Diferencia`)),`t1`.`Diferencia`,0)) AS `DiferenciaXGlosaFavorEPS`,(select if((abs(`t1`.`TotalGlosaContra`) = abs(`t1`.`Diferencia`)),`t1`.`Diferencia`,0)) AS `DiferenciaXGlosaContraEPS`,(select if((abs(`t1`.`GlosaXConciliar`) = abs(`t1`.`Diferencia`)),`t1`.`Diferencia`,0)) AS `DiferenciaXGlosaXConciliar`,(select if((abs(`t1`.`TotalDevoluciones`) = abs(`t1`.`Diferencia`)),`t1`.`Diferencia`,0)) AS `DiferenciaXDevoluciones`,(select if((abs(`t1`.`Impuestos`) = abs(`t1`.`Diferencia`)),`t1`.`Diferencia`,0)) AS `DiferenciaXImpuestos`,(select if((`t1`.`ValorSegunIPS` > `t1`.`ValorDocumento`),`t1`.`Diferencia`,0)) AS `DiferenciaXValorFacturado`,((((((((((((select `DiferenciaXPagos`) + (select `DiferenciaXAnticipos`)) + (select `DiferenciaXCopagos`)) + (select `DiferenciaXDescuentoPGP`)) + (select `DiferenciaXOtrosDescuentos`)) + (select `DiferenciaXAjustesCartera`)) + (select `DiferenciaXGlosaFavorEPS`)) + (select `DiferenciaXGlosaContraEPS`)) + (select `DiferenciaXGlosaXConciliar`)) + (select `DiferenciaXDevoluciones`)) + (select `DiferenciaXImpuestos`)) + (select `DiferenciaXValorFacturado`)) AS `TotalDiferenciasComunes`,(select if((((select `TotalDiferenciasComunes`) = 0) and (`t1`.`ValorSegunEPS` = 0) and (abs(`t1`.`TotalDevoluciones`) > 0)),`t1`.`Diferencia`,0)) AS `DiferenciaXDevolucionesNoIPS`,(select if((((select `TotalDiferenciasComunes`) = 0) and ((select `DiferenciaXDevolucionesNoIPS`) = 0) and (abs(`t1`.`TotalPagos`) > 0) and (abs(`t1`.`GlosaXConciliar`) > 0)),`t1`.`GlosaXConciliar`,0)) AS `GlosasXConciliar2`,(select if((((select `TotalDiferenciasComunes`) = 0) and ((select `DiferenciaXDevolucionesNoIPS`) = 0) and (abs(`t1`.`TotalPagos`) > 0) and (abs(`t1`.`GlosaXConciliar`) > 0)),`t1`.`TotalPagos`,0)) AS `XPagos2`,(select if((((select `TotalDiferenciasComunes`) = 0) and (abs(`DiferenciaXDevolucionesNoIPS`) = 0) and (abs(`GlosasXConciliar2`) = 0)),`t1`.`Diferencia`,0)) AS `DiferenciaVariada` from `vista_cruce_cartera_asmet` `t1` where (`t1`.`Diferencia` <> 0);
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `vista_reporte_ips` AS select `t2`.`FechaFactura` AS `Fecha Factura`,`t2`.`MesServicio` AS `Mes servicio`,`t2`.`NumeroRadicado` AS `Numero Radicado`,`t2`.`FechaRadicado` AS `Fecha Radicado`,`t2`.`NumeroContrato` AS `Numero Contrato`,`t2`.`NumeroFactura` AS `Numero factura`,`t2`.`ValorDocumento` AS `Valor de Factura`,`t2`.`Impuestos` AS `Impuestos Factura`,`t2`.`TotalPagos` AS `Pagos`,`t2`.`TotalAnticipos` AS `Anticipos`,`t2`.`TotalCopagos` AS `Copagos`,`t2`.`DescuentoPGP` AS `Descuentos PGP`,`t2`.`OtrosDescuentos` AS `Otros Descuentos`,`t2`.`AjustesCartera` AS `Ajustes Cartera`,`t2`.`TotalGlosaFavor` AS `Glosa Aceptada Ips`,`t2`.`TotalGlosaContra` AS `Glosa levantada EPS`,`t2`.`GlosaXConciliar` AS `Glosa X Conciliar`,`t2`.`TotalDevoluciones` AS `Devoluciones`,`t2`.`ValorSegunEPS` AS `Saldo Eps`,`t2`.`ValorSegunIPS` AS `Saldo Ips`,`t2`.`Diferencia` AS `Valor Diferencia` from `vista_cruce_cartera_eps_relacionadas_ips` `t2` where ((`t2`.`ValorIPSMenor` = 'NO') and (`t2`.`Diferencia` <> '0'));
