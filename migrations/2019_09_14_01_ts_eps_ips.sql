...
CREATE TABLE `conciliaciones_cruces` (
  ...
  `NumeroContrato` varchar(40) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Numero de contrato al que esta sujeto la factura',
  `NumeroFactura` varchar(20) COLLATE utf8_spanish_ci NOT NULL COMMENT 'N̼mero de la factura del prestador',
  `MesServicio` int(6) DEFAULT NULL COMMENT 'A̱o y mes que se presta el servicio',
...
CREATE TABLE `hoja_de_trabajo` (
  ...
  `DepartamentoRadicacion` varchar(25) COLLATE utf8_spanish_ci DEFAULT NULL,
  `NoRelacionada` int(1) DEFAULT NULL,
  `FechaFactura` date DEFAULT NULL,
  `MesServicio` int(6) DEFAULT NULL,
  `NumeroRadicado` varchar(90) COLLATE utf8_spanish_ci DEFAULT NULL,
  `Pendientes` varchar(2) COLLATE utf8_spanish_ci DEFAULT NULL,
  `PendientesXRadicados` varchar(2) COLLATE utf8_spanish_ci DEFAULT NULL,
  `PendientesXCopagos` varchar(2) COLLATE utf8_spanish_ci DEFAULT NULL,
  `PendientesXAuditoria` varchar(2) COLLATE utf8_spanish_ci DEFAULT NULL,
  `PendientesXNotas` varchar(2) COLLATE utf8_spanish_ci DEFAULT NULL,
  `FechaConciliacion` datetime DEFAULT NULL,
  `FechaRadicado` date DEFAULT NULL,
  `NumeroContrato` varchar(40) COLLATE utf8_spanish_ci DEFAULT NULL,
  `ValorDocumento` double(15,2) DEFAULT NULL,
  `Impuestos` double(19,2) DEFAULT NULL,
  `ImpuestosSegunASMET` double(19,2) DEFAULT NULL,
  `ValorMenosImpuestos` double(15,2) DEFAULT NULL,
  `TotalPagosNotas` double(19,2) DEFAULT NULL,
  `Capitalizacion` double(19,2) DEFAULT NULL,
  `TotalPagos` double(19,2) DEFAULT NULL,
  `TotalAnticipos` double(19,2) DEFAULT NULL,
  `DescuentoPGP` double(19,2) DEFAULT NULL,
  `FacturasDevueltas` double(19,2) DEFAULT NULL,
  `NumeroFacturasDevueltasAnticipos` bigint(21) DEFAULT NULL,
  `ValorFacturasDevueltascxpvsant` double(19,2) DEFAULT NULL,
  `FacturasDevueltasCXPVSANT` bigint(21) DEFAULT NULL,
  `TotalCopagos` double(19,2) DEFAULT NULL,
  `OtrosDescuentos` double(19,2) DEFAULT NULL,
  `AjustesCartera` double(19,2) DEFAULT NULL,
  `TotalGlosaInicial` double(15,2) DEFAULT NULL,
  `TotalGlosaFavor` double(15,2) DEFAULT NULL,
  `TotalGlosaContra` double(15,2) DEFAULT NULL,
  `GlosaXConciliar` double(19,2) DEFAULT NULL,
  `DevolucionesPresentadas` bigint(21) DEFAULT NULL,
  `FacturasPresentadas` bigint(21) DEFAULT NULL,
  `FacturaActiva` varchar(2) COLLATE utf8_spanish_ci DEFAULT NULL,
  `TotalDevolucionesNotas` double(15,2) DEFAULT NULL,
  `TotalDevoluciones` double(19,2) DEFAULT NULL,
  `CarteraXEdades` double(19,2) DEFAULT NULL,
  `ConciliacionesAFavorEPS` double(19,2) DEFAULT NULL,
  `ConciliacionesAFavorIPS` double(19,2) DEFAULT NULL,
  `ValorSegunEPS` double(19,2) DEFAULT NULL,
  `ValorSegunIPS` double(17,0) DEFAULT NULL,
  `Diferencia` double(19,2) DEFAULT NULL,
  `ValorIPSMenor` varchar(2) COLLATE utf8_spanish_ci DEFAULT NULL,
  `TotalConciliaciones` double(19,2) DEFAULT NULL,
  `TotalAPagar` double(19,2) DEFAULT NULL,
  `ConciliacionesPendientes` varchar(2) COLLATE utf8_spanish_ci DEFAULT NULL,
  `DiferenciaXPagos` int(1) DEFAULT NULL,
  `DescripcionPagos` text COLLATE utf8_spanish_ci,
  `DiferenciaXPagosNoDescargados` double DEFAULT NULL,
  `DiferenciaXGlosasPendientesXConciliar` double DEFAULT NULL,
  `DiferenciaXFacturasDevueltas` double DEFAULT NULL,
  `DiferenciaXDiferenciaXImpuestos` double DEFAULT NULL,
  `DiferenciaXDescuentoXRetefuente` double DEFAULT NULL,
  `DiferenciaXFacturasNoRelacionadasXIPS` double DEFAULT NULL,
  `DiferenciaXRetencionesImpuestosNoProcedentes` double DEFAULT NULL,
  `DiferenciaXAjustesDeCartera` double DEFAULT NULL,
  `DiferenciaXValorFacturado` double DEFAULT NULL,
  `DiferenciaXUPC` double DEFAULT NULL,
  `DiferenciaXGlosasPendientesXDescargarIPS` double DEFAULT NULL,
  `DiferenciaXAnticiposPendientesXCruzar` double DEFAULT NULL,
  `DiferenciaXDescuentosLMA` double DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `NumeroFactura` (`NumeroFactura`),
  KEY `Estado` (`Estado`),
  KEY `MesServicio` (`MesServicio`),
...
CREATE TABLE `notas_db_cr_2` (
  ...
  KEY `TipoOperacion2_2` (`TipoOperacion2`)
...
CREATE TABLE `temporalcarguecarteraeps` (
  ...
  `TipoOperacionCF` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'tipos de operacion en cruces de facturacion',
  `NumeroTransaccionCF` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'numeros de documentos de transaccion',
  `FechaTransaccionCF` date NOT NULL,
  `ValorCruceTransaccionCF` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'valores que cruzaron con la facura',
  `TipoOperacionPF` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'tipos de operacion en pagos de facturacion',
  `NumeroTransaccionPF` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'numeros de documentos de transaccion en pagos de facturacion',
  `FechaTransaccionPF` date NOT NULL,
  `ValorPagadoPF` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'valores que pagaron en la facura',
  `NumeroPlanoPF` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'numero del los planos en pagos de facturacion',
  `FechaPlanoPF` date NOT NULL,
  `TipoOperacionGA2702` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'tipos de operaciones en glosas antes del decreto 2702/2014',
  `FechaTransaccionGA2702` date NOT NULL,
  `NumeroTransaccionGA2702` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'numeros de documentos de transaccion en glosas antes del decreto 2702/2014',
  `ValorCruceTransaccionGA2702` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'valores cruzados en glosas antes del decreto 2702/2014',
  `TipoOperacionGD2702` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'tipos de operaciones en glosas despues del decreto 2702/2014',
  `FechaTransaccionGD2702` date NOT NULL,
  `NumeroTransaccionGD2702` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'numeros de documentos de transaccion en glosas despues del decreto 2702/2014',
  `ValorCruceTransaccionGD2702` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'valores cruzados en glosas despues del decreto 2702/2014',
  `NumeroPlanoGD2702` varchar(300) COLLATE utf8_spanish_ci NOT NULL COMMENT 'numero del los planos en glosas despues del decreto 2702/2014',
  `DescuentoBdua` double(15,2) NOT NULL COMMENT 'Valor de descuento en base de datos unico de afiliados',
