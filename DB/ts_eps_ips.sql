...
DROP TABLE IF EXISTS `anticipos2`;
CREATE TABLE `anticipos2` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `NumeroInterno` varchar(20) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Número del documento',
  ...
  `NumeroOperacion` varchar(20) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Número de la operacion',
...
DROP TABLE IF EXISTS `carteraxedades`;
CREATE TABLE `carteraxedades` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `TipoOperacion` int(6) NOT NULL,
  `NumeroDocumento` varchar(20) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Número de la transaccion',
  `NumeroFactura` varchar(20) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Número de la factura del prestador',
  `NumeroRadicado` varchar(20) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Número de la radicado',
...
DROP TABLE IF EXISTS `comprobantesegresoasmet`;
CREATE TABLE `comprobantesegresoasmet` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `TipoOperacion` int(5) DEFAULT NULL COMMENT 'Tipo de Operacion',
  `NumeroComprobante` varchar(20) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Número del comprobante',
  ...
  `CuentaBancaria` bigint(20) NOT NULL COMMENT 'Número de cuenta a la cual re remite el pago',
  `Banco` varchar(20) COLLATE utf8_spanish_ci NOT NULL COMMENT 'banco de tranferencia',
  `NumeroInterno` varchar(15) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Número interno',
  `NumeroFactura` varchar(20) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Número de la factura del prestador',
...
DROP TABLE IF EXISTS `notas_db_cr_2`;
CREATE TABLE `notas_db_cr_2` (
  ...
  `AnoTransaccion` int(4) DEFAULT NULL COMMENT 'Año en que se hace la transaccion',
  ...
  `NumeroFactura` varchar(20) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Número de la factura del prestador',
  `Proveedor` bigint(20) NOT NULL COMMENT 'Número de identificación del prestador de servicios de salud',
  `RazonSocial` varchar(60) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Razón social o apellidos y nombre del prestador',
  ...
  `CuentaContable` int(20) DEFAULT NULL COMMENT 'Número de la cuenta contable',
...
DROP TABLE IF EXISTS `notas_dv_cr`;
...
DROP TABLE IF EXISTS `temporal_anticipos2`;
...
DROP TABLE IF EXISTS `temporal_carteraxedades`;
...
DROP TABLE IF EXISTS `temporal_comprobantesegresoasmet`;
...
DROP TABLE IF EXISTS `temporal_notas_db_cr_2`;
...
DROP TABLE IF EXISTS `temporal_notas_dv_cr`;
...
CREATE TABLE `vista_cruce_cartera_asmet` (`ID` bigint(20), `NumeroFactura` varchar(20), `FechaFactura` date, `NumeroRadicado` varchar(20), `FechaRadicado` date, `NumeroContrato` varchar(40), `ValorDocumento` double(15,2), `ValorMenosImpuestos` double(15,2), `Impuestos` double(19,2), `OtrosDescuentos` varchar(1), `TotalPagos` double(19,2), `TotalAnticipos` double(19,2), `TotalGlosaInicial` double(19,2), `TotalGlosaFavor` double(19,2), `TotalGlosaContra` double(19,2), `TotalCopagos` double(19,2), `TotalDevoluciones` double(19,2), `GlosaXConciliar` double(19,2), `ValorSegunEPS` double, `ValorSegunIPS` double(15,2), `Diferencia` double, `CarteraXEdades` double(15,2));
...
CREATE TABLE `vista_resumen_cruce_cartera_asmet` (`NumeroContrato` varchar(40), `TotalFacturas` double(19,2), `Impuestos` double(19,2), `TotalMenosImpuestos` double(19,2), `TotalOtrosDescuentos` double, `TotalPagos` double(19,2), `TotalAnticipos` double(19,2), `TotalGlosaInicial` double(19,2), `TotalGlosaFavor` double(19,2), `TotalGlosaContra` double(19,2), `TotalGlosaXConciliar` double(19,2), `TotalCopagos` double(19,2), `TotalDevoluciones` double(19,2), `ValorSegunEPS` double);


DROP TABLE IF EXISTS `vista_cruce_cartera_asmet`;
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `vista_cruce_cartera_asmet` AS select `t1`.`ID` AS `ID`,`t1`.`NumeroFactura` AS `NumeroFactura`,`t1`.`FechaFactura` AS `FechaFactura`,`t1`.`NumeroRadicado` AS `NumeroRadicado`,`t1`.`FechaRadicado` AS `FechaRadicado`,`t2`.`NumeroContrato` AS `NumeroContrato`,`t1`.`ValorDocumento` AS `ValorDocumento`,`t2`.`ValorMenosImpuestos` AS `ValorMenosImpuestos`,(`t1`.`ValorDocumento` - `t2`.`ValorMenosImpuestos`) AS `Impuestos`,'0' AS `OtrosDescuentos`,(select ifnull((select sum(`pagos_asmet`.`ValorTranferido`) from `pagos_asmet` where (`pagos_asmet`.`NumeroFactura` = `t1`.`NumeroFactura`)),0)) AS `TotalPagos`,(select ifnull((select sum(`anticipos_asmet`.`ValorAnticipado`) from `anticipos_asmet` where (`anticipos_asmet`.`NumeroFactura` = `t1`.`NumeroFactura`)),0)) AS `TotalAnticipos`,(select ifnull((select sum(`glosaseps_asmet`.`ValorTotalGlosa`) from `glosaseps_asmet` where (`glosaseps_asmet`.`NumeroFactura` = `t1`.`NumeroFactura`)),0)) AS `TotalGlosaInicial`,(select ifnull((select sum(`glosaseps_asmet`.`ValorGlosaFavor`) from `glosaseps_asmet` where (`glosaseps_asmet`.`NumeroFactura` = `t1`.`NumeroFactura`)),0)) AS `TotalGlosaFavor`,(select ifnull((select sum(`glosaseps_asmet`.`ValorGlosaContra`) from `glosaseps_asmet` where (`glosaseps_asmet`.`NumeroFactura` = `t1`.`NumeroFactura`)),0)) AS `TotalGlosaContra`,(select ifnull((select sum(`notas_db_cr_2`.`ValorTotal`) from `notas_db_cr_2` where ((`notas_db_cr_2`.`NumeroFactura` = `t1`.`NumeroFactura`) and (`notas_db_cr_2`.`TipoOperacion` = '2258'))),0)) AS `TotalCopagos`,(select ifnull((select sum(`notas_db_cr_2`.`ValorTotal`) from `notas_db_cr_2` where ((`notas_db_cr_2`.`NumeroFactura` = `t1`.`NumeroFactura`) and (`notas_db_cr_2`.`TipoOperacion` = '2259'))),0)) AS `TotalDevoluciones`,(((select `TotalGlosaInicial`) - (select `TotalGlosaFavor`)) - (select `TotalGlosaContra`)) AS `GlosaXConciliar`,(((((((`t1`.`ValorDocumento` - (select `Impuestos`)) - (select `TotalPagos`)) - (select `TotalAnticipos`)) - (select `TotalGlosaFavor`)) - (select `OtrosDescuentos`)) - (select `TotalCopagos`)) - (select `TotalDevoluciones`)) AS `ValorSegunEPS`,`t1`.`ValorTotalpagar` AS `ValorSegunIPS`,((select `ValorSegunEPS`) - (select `ValorSegunIPS`)) AS `Diferencia`,(select ifnull((select `carteraxedades`.`ValorTotalcartera` from `carteraxedades` where (`carteraxedades`.`NumeroFactura` = `t1`.`NumeroFactura`) limit 1),0)) AS `CarteraXEdades` from (`carteracargadaips` `t1` join `carteraeps` `t2` on((`t1`.`NumeroFactura` = `t2`.`NumeroFactura`)));
