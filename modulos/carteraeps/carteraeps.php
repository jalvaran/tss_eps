...
$css->PageInit($myTitulo);
    ...
    $css->CrearDiv("", "col-md-12", "left", 1, 1); 
        $css->h3("", "", "", "");
                print("<strong>Cargue de Cartera de EPS</strong>");
        $css->Ch3();
    $css->CerrarDiv(); 
    ...
    $css->CrearDiv("", "col-md-2", "center", 1, 1);
        print("<strong>Cartera hasta:</strong><br>");
...
$css->PageFin();
print('<script src="jsPages/carteraeps.js"></script>');  //script propio de la pagina
