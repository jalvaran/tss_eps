 ...
 * 
 */
$myPage="cargar_egresos.php";
$myTitulo="Cargar Egresos";
...
$css->PageInit($myTitulo);
    ...
    $css->CrearDiv("", "col-md-12", "left", 1, 1); 
        $css->h3("", "", "", "");
                print("<strong>Cargar Archivo de Egresos</strong>");
        $css->Ch3();
    $css->CerrarDiv(); 
...
$css->PageFin();
print('<script src="jsPages/cargar_egresos.js"></script>');  //script propio de la pagina
