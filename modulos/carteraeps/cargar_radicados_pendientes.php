 ...
 * 
 */
$myPage="cargar_radicados_pendientes.php";
$myTitulo="Cargar Radicados Pendientes EPS";
...
$css->PageInit($myTitulo);
    ...
    $css->CrearDiv("", "col-md-12", "left", 1, 1); 
        $css->h3("", "", "", "");
                print("<strong>Cargue de Radicados Pendientes de EPS</strong>");
        $css->Ch3();
    $css->CerrarDiv(); 
...
$css->PageFin();
print('<script src="jsPages/cargar_radicados_pendientes.js"></script>');  //script propio de la pagina
