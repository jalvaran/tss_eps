<?php
/**
 * Pagina para Subir los copagos pendientes por parte de una EPS
 ...
 * 
 */
$myPage="cargar_copagos_pendientes.php";
$myTitulo="Cargar Copagos Pendientes EPS";
...
$css->PageInit($myTitulo);
    ...
    $css->CrearDiv("", "col-md-12", "left", 1, 1); 
        $css->h3("", "", "", "");
                print("<strong>Cargar Copagos Pendientes de EPS</strong>");
        $css->Ch3();
    $css->CerrarDiv(); 
...
$css->PageFin();
print('<script src="jsPages/cargar_copagos_pendientes.js"></script>');  //script propio de la pagina
