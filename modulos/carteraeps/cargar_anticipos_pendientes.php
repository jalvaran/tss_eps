<?php
/**
 * Pagina para Subir los anticipos pendientes
 * 2019-10-18, Julian Alvaran Techno Soluciones SAS
 * 
 ...
 * 
 */
$myPage="cargar_anticipos_pendientes.php";
$myTitulo="Anticipos pendientes por cruzar";
...
$css->PageInit($myTitulo);
    ...
    $css->CrearDiv("", "col-md-12", "left", 1, 1); 
        $css->h3("", "", "", "");
                print("<strong>Cargar Anticipos Pendientes por Legalizar</strong>");
        $css->Ch3();
    $css->CerrarDiv(); 
...
$css->PageFin();
print('<script src="jsPages/cargar_anticipos_pendientes.js"></script>');  //script propio de la pagina
