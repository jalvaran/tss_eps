<?php
/**
 * Pagina para Subir las notas credito y debito por parte de una EPS
 ...
 * 
 */
$myPage="carteraxedades.php";
$myTitulo="Cartera X Edades";
...
$css->PageInit($myTitulo);
    ...
    $css->CrearDiv("", "col-md-12", "left", 1, 1); 
        $css->h3("", "", "", "");
                print("<strong>Cargar Cartera Por Edades</strong>");
        $css->Ch3();
    $css->CerrarDiv(); 
...
$css->PageFin();
print('<script src="jsPages/carteraxedades.js"></script>');  //script propio de la pagina
