/**
 * Controlador para notas pendientes
 * JULIAN ALVARAN 2019-07-11
...
function ConfirmarCarga(){
    ...
    alertify.confirm('Está seguro que desea Cargar este archivo?',
        function (e) {
            if (e) {
...
function VerifiqueFechaCargue(){
    ...
    var form_data = new FormData();
        ...
        $.ajax({
        url: './procesadores/cargar_notas_pendientes.process.php',
        //dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
    ...
    $.ajax({
        ...
        success: function(data){
           ...
           if(respuestas[0]==="OK"){   
                ...
                document.getElementById('DivMensajes').innerHTML=document.getElementById('DivMensajes').innerHTML+"<br>Carga a Temporal Terminada ";
                CopiarRegistros();
...
function CopiarRegistros(){
    document.getElementById('DivMensajes').innerHTML=document.getElementById('DivMensajes').innerHTML+"<br>Empezando Copia a la tabla real";
    var FechaCorteCartera=document.getElementById('FechaCorteCartera').value;
    var CmbEPS=document.getElementById('CmbEPS').value;
    var CmbIPS=document.getElementById('CmbIPS').value;
