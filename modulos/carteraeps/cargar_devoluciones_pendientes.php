<?php
/**
 * Pagina para Subir las devoluciones pendientes por parte de una EPS
 * 2019-07-11, Julian Alvaran Techno Soluciones SAS
 * 
 ...
 * 
 */
$myPage="cargar_devoluciones_pendientes.php";
$myTitulo="Cargar Devoluciones Pendientes EPS";
...
$css->PageInit($myTitulo);
    ...
    $css->CrearDiv("", "col-md-12", "left", 1, 1); 
        $css->h3("", "", "", "");
                print("<strong>Cargar Devoluciones Pendientes de EPS</strong>");
        $css->Ch3();
    $css->CerrarDiv(); 
...
$css->PageFin();
print('<script src="jsPages/cargar_devoluciones_pendientes.js"></script>');  //script propio de la pagina
