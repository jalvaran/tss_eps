<?php
/**
 * Pagina para Subir las notas pendientes por parte de una EPS
 ...
 * 
 */
$myPage="cargar_notas_pendientes.php";
$myTitulo="Cargar Notas Pendientes EPS";
...
$css->PageInit($myTitulo);
    ...
    $css->CrearDiv("", "col-md-12", "left", 1, 1); 
        $css->h3("", "", "", "");
                print("<strong>Cargar Notas Pendientes de EPS</strong>");
        $css->Ch3();
    $css->CerrarDiv(); 
...
$css->PageFin();
print('<script src="jsPages/cargar_notas_pendientes.js"></script>');  //script propio de la pagina
