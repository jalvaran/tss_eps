 ...
 * 
 */
$myPage="historial_contratos_liquidados.php";
$myTitulo="Historial de contratos liquidados";
...
print('<script>SeleccioneTablaDB(`registro_liquidacion_contratos`)</script>');  //script propio de la pagina
