...
$css->PageInit($myTitulo);
    ...
    $css->CrearDiv("", "col-md-12", "left", 1, 1); 
        $css->h3("", "", "", "");
                print("<strong>Cartera de la IPS</strong>");
        $css->Ch3();
    $css->CerrarDiv(); 
    ...
    $css->CrearDiv("", "col-md-6", "center", 1, 1);
        ...
        $css->select("CmbIPS", "form-control", "CmbIPS", "IPS<br>", "", "", "onchange=SeleccionarTablaTsEPS('carteracargadaips')");
            $css->option("", "", "", '', "", "");
