 ...
 * 
 */
$myPage="vista_pagos_actas_liquidaciones_manuales.php";
...
$css->PageInit($myTitulo);
    ...
    $css->CrearDiv("", "col-md-12", "left", 1, 1); 
        $css->h3("", "", "", "");
                print("<strong>Items Contratos Subidos Manualmente</strong>");
        $css->Ch3();
    $css->CerrarDiv(); 
    ...
    $css->CrearDiv("", "col-md-6", "center", 1, 1);
        ...
        $css->select("CmbIPS", "form-control", "CmbIPS", "IPS<br>", "", "", "onchange=SeleccionarTablaTsEPS('vista_pagos_actas_liquidaciones_manuales')");
            $css->option("", "", "", '', "", "");
