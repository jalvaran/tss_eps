/**
 * Controlador para cargar el reporte del contrato de liquidacion
 * JULIAN ALVARAN 2019-06-27
...
function VerifiqueCargue(){
    ...
    var form_data = new FormData();
        ...
        $.ajax({
        url: './procesadores/CargarReporteContratoLiquidacion.process.php',
        //dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
...
function EnviarArchivo(){
    ...
    if($('#NumeroContrato').val()==null || $('#NumeroContrato').val()==''){
          alertify.alert("por favor escriba un Número de contrato");   
          document.getElementById('BtnSubir').disabled=false;
          document.getElementById('BtnSubir').value="Ejecutar";
          document.getElementById('NumeroContrato').style.backgroundColor="pink";
          return;
    }else{
        document.getElementById('NumeroContrato').style.backgroundColor="white";
    }
    ...
    var form_data = new FormData();
        ...
        form_data.append('NumeroContrato', $('#NumeroContrato').val());       
        form_data.append('CmbIPS', CmbIPS);
...
function GuardeEnTemporal(){
    ...
    if($('#NumeroContrato').val()==null || $('#NumeroContrato').val()==''){
          alertify.alert("por favor seleccione un Numero de Contrato");   
          document.getElementById('BtnSubir').disabled=false;
          document.getElementById('BtnSubir').value="Ejecutar";
          document.getElementById('NumeroContrato').style.backgroundColor="pink";
          return;
