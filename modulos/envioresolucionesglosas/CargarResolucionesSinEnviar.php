<?php
/**
 * Pagina para Subir las resoluciones sin enviar por parte de ASMET
 ...
 * 
 */
$myPage="CargarResolucionesSinEnviar.php";
$myTitulo="Cargar Resoluciones Sin Enviar";
...
$css->PageInit($myTitulo);
    ...
    $css->CrearDiv("", "col-md-12", "left", 1, 1); 
        $css->h3("", "", "", "");
                print("<strong>Cargar Archivo de Resoluciones sin Enviar</strong>");
        $css->Ch3();
    $css->CerrarDiv(); 
...
$css->PageFin();
print('<script src="jsPages/CargarResolucionesSinEnviar.js"></script>');  //script propio de la pagina
