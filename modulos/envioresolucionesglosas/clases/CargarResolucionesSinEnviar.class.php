...
class CargarResolucionesSinEnviar extends conexion{
    ...
    public function GuardeArchivoEnTemporal($keyArchivo,$db,$idUser) {
        ...
        $ColumnasTabla= $this->ShowColums($db.".temp_resoluciones_glosas_radicados_sin_enviar");
        ...
        //for ($h=0;$h<$hojas;$h++){
            ...
            $sql= "INSERT INTO $db.`temp_resoluciones_glosas_radicados_sin_enviar` ( ";
            ...
            for ($i=1;$i<=$filas;$i++){
                ...
                $NumeroRadicado=$objPHPExcel->getActiveSheet()->getCell('A'.$i)->getCalculatedValue();
                $NumeroRadicado= str_replace("'", "", $NumeroRadicado);
                $sql.="'$NumeroRadicado',";

                $ValorRadicado=$objPHPExcel->getActiveSheet()->getCell('B'.$i)->getCalculatedValue();
                $ValorRadicado= str_replace("'", "", $ValorRadicado);
                $ValorRadicado= str_replace(" ", "", $ValorRadicado);
                $ValorRadicado= str_replace(".", "", $ValorRadicado);
                $sql.="'$ValorRadicado',";
