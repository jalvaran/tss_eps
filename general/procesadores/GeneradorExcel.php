...
if(isset($_REQUEST["idDocumento"])){
    ...
    switch ($idDocumento){
        ...
        case 2: //Formato de anexo a acta de liquidaciones
            ...
            if($DatosActa["TipoActaLiquidacion"]==1 or $DatosActa["TipoActaLiquidacion"]==2 or $DatosActa["TipoActaLiquidacion"]==3 or $DatosActa["TipoActaLiquidacion"]==7 or $DatosActa["TipoActaLiquidacion"]==9){
