...
SELECT t2.ID,t2.NumeroFactura,t2.Estado,t2.DepartamentoRadicacion,t1.NoRelacionada,
        ...
        (SELECT IFNULL((SELECT COUNT(DISTINCT NumeroTransaccion) FROM notas_db_cr_2 WHERE notas_db_cr_2.NumeroFactura=t2.NumeroFactura AND notas_db_cr_2.C13<>'N' AND (notas_db_cr_2.TipoOperacion='2259' OR notas_db_cr_2.TipoOperacion='2269' OR notas_db_cr_2.TipoOperacion='2039' OR notas_db_cr_2.TipoOperacion='2088' ) ),0)) AS DevolucionesPresentadas,
...
SELECT  t2.FechaFactura AS 'Fecha Factura',
        ...
        t2.TotalGlosaInicial AS 'Glosa inicial',
...
FROM vista_cruce_cartera_asmet t2;
